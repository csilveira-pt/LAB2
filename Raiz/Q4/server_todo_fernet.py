...
# Comentei a classe acima e substituí por esta
class TodoItem:
...
class TodoList:
    ...
    # Comentei a de cima para alterar o método
...
try:
    with open('todo_list.fernet', 'r') as file:
        ...
        for line in file:
            ...
            # comentei as duas linhas acima e substituí por estas abaixo
            title, description, completed_str = plain_item.split(",")
            # converter a string "True"/"False" para booleano
            completed = (completed_str == "True")
            # agora passamos o valor correto
